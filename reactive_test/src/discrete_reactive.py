...
nb_stage = 8
list_position =[0, 7 , 63 , 56 , 9 , 14, 54 ,49]
stage_init = 0
...
env_safe = set()
env_prog = set()
env_prog |= {'env1 = '+str(number_cell/2)}
...
for iter1 in range(dim*dim):
	if(iter1 % dim != 0 ) and (iter1 % dim != dim-1) and (iter1/dim != 0) and (iter1/dim != dim-1) : #Case inside the grid
		env_safe |= {('(env1 = '+str(iter1)+') -> X((env1 = '+str(iter1)+') || (env1='+str(iter1+1) + ') || (env1='+str(iter1-1)+') || (env1='+str(iter1-dim)+') || (env1 = '+str(iter1+dim)+'))')}
		#env_safe |= {('(env1 = '+str(iter1)+') -> X((env1='+str(iter1+1) + ') || (env1='+str(iter1-1)+') || (env1='+str(iter1-dim)+') || (env1 = '+str(iter1+dim)+'))')}
		sys_safe |= {('(loc = '+str(iter1)+') -> X((loc = '+str(iter1)+') || (loc='+str(iter1+1) + ') || (loc='+str(iter1-1)+') || (loc='+str(iter1-dim)+') || (loc = '+str(iter1+dim)+'))')}
		#sys_safe |= {('(loc = '+str(iter1)+') -> X((loc='+str(iter1+1) + ') || (loc='+str(iter1-1)+') || (loc='+str(iter1-dim)+') || (loc = '+str(iter1+dim)+'))')}
		sys_safe |= {'!(env1 = '+str(iter1)+') || (!(loc = '+str(iter1+1)+') && !(loc = '+str(iter1-1)+') && !(loc = '+str(iter1+dim)+') && !(loc = '+str(iter1-dim)+') && !(loc = '+str(iter1)+'))'}
	elif (iter1 % dim == 0) and (iter1 / dim  !=0) and (iter1/dim != dim-1): #Case on the left corner of the grid excep left up and down
		env_safe |= {('(env1 = '+str(iter1)+') -> X((env1 = '+str(iter1)+') || (env1='+str(iter1+1) + ') || (env1='+str(iter1-dim)+') || (env1 = '+str(iter1+dim)+'))')}
		#env_safe |= {('(env1 = '+str(iter1)+') -> X((env1='+str(iter1+1) + ') || (env1='+str(iter1-dim)+') || (env1 = '+str(iter1+dim)+'))')}
		sys_safe |= {('(loc = '+str(iter1)+') -> X((loc = '+str(iter1)+') || (loc='+str(iter1+1) + ') || (loc='+str(iter1-dim)+') || (loc = '+str(iter1+dim)+'))')}
		#sys_safe |= {('(loc = '+str(iter1)+') -> X((loc='+str(iter1+1) + ') || (loc='+str(iter1-dim)+') || (loc = '+str(iter1+dim)+'))')}
		sys_safe |= {'!(env1 = '+str(iter1)+') || (!(loc = '+str(iter1+1)+') && !(loc = '+str(iter1+dim)+') && !(loc = '+str(iter1-dim)+') && !(loc = '+str(iter1)+'))'}
		...
		env_safe |= {('(env1 = '+str(iter1)+') -> X((env1 = '+str(iter1)+') || (env1='+str(iter1+1) + ') || (env1='+str(iter1-1)+') || (env1='+str(iter1-dim)+'))')}
		#env_safe |= {('(env1 = '+str(iter1)+') -> X((env1='+str(iter1+1) + ') || (env1='+str(iter1-1)+') || (env1='+str(iter1-dim)+'))')}
		sys_safe |= {('(loc = '+str(iter1)+') -> X((loc = '+str(iter1)+') || (loc='+str(iter1+1) + ') || (loc='+str(iter1-1)+') || (loc='+str(iter1-dim)+'))')}
		#sys_safe |= {('(loc = '+str(iter1)+') -> X((loc='+str(iter1+1) + ') || (loc='+str(iter1-1)+') || (loc='+str(iter1-dim)+'))')}
		sys_safe |= {'!(env1 = '+str(iter1)+') || (!(loc = '+str(iter1+1)+') && !(loc = '+str(iter1-1)+') && !(loc = '+str(iter1-dim)+') && !(loc = '+str(iter1)+'))'}
		...
		env_safe |= {('(env1 = '+str(iter1)+') -> X((env1 = '+str(iter1)+') || (env1='+str(iter1+1) + ') || (env1='+str(iter1+dim)+'))')}
		#env_safe |= {('(env1 = '+str(iter1)+') -> X((env1='+str(iter1+1) + ') || (env1='+str(iter1+dim)+'))')}
		sys_safe |= {('(loc = '+str(iter1)+') -> X((loc = '+str(iter1)+') || (loc='+str(iter1+1) + ') || (loc='+str(iter1+dim)+'))')}
		#sys_safe |= {('(loc = '+str(iter1)+') -> X((loc='+str(iter1+1) + ') || (loc='+str(iter1+dim)+'))')}
		sys_safe |= {'!(env1 = '+str(iter1)+') || (!(loc = '+str(iter1+1)+') && !(loc = '+str(iter1+dim)+') && !(loc = '+str(iter1)+'))'}
	elif (iter1 == dim-1) :
		env_safe |= {('(env1 = '+str(iter1)+') -> X((env1 = '+str(iter1)+') || (env1='+str(iter1-1) + ') || (env1='+str(iter1+dim)+'))')}
		#env_safe |= {('(env1 = '+str(iter1)+') -> X((env1='+str(iter1-1) + ') || (env1='+str(iter1+dim)+'))')}
		sys_safe |= {('(loc = '+str(iter1)+') -> X((loc = '+str(iter1)+') || (loc='+str(iter1-1) + ') || (loc='+str(iter1+dim)+'))')}
...
# #The sys robot can never exchange position with the environment robot
