...
class FollowMeCtrl_50_obs(object):
    """Mealy transducer.
    ...
    Automatically generated by tulip.dumpsmach on 2017-07-10 23:45:20 UTC
    To learn more about TuLiP, visit http://tulip-control.org
    """
    def __init__(self):
        self.state = 17328
        self.input_vars = ['env1']
        self.database = sqlite3.connect("FollowMeCtrl_50_obs_db.db")
