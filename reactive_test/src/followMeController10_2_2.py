...
class FollowCtrl10_2_2(object):
    ...
    Automatically generated by tulip.dumpsmach on 2017-06-27 15:11:22 UTC
    To learn more about TuLiP, visit http://tulip-control.org
    """
    def __init__(self):
        self.state = 11900
        self.input_vars = ['sys_delta_row', 'env1', 'sys_delta_col']
        self.database = sqlite3.connect("FollowCtrl10_2_2_db.db")
