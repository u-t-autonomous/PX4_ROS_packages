...
class target_envController(object):
    """Mealy transducer.
    ...
    Automatically generated by tulip.dumpsmach on 2017-08-17 18:38:27 UTC
    To learn more about TuLiP, visit http://tulip-control.org
    """
    def __init__(self):
        self.state = 527
        self.input_vars = ['target_Quad9']
        self.database = sqlite3.connect("target_envController_db.db")
    ...
    def move(self, target_Quad9):
        ...
        self.cursor.execute("select next_state,Quad9,stage_Quad9 from state_trans where current_state=:current_state and target_Quad9=:target_Quad9",req_arg)
        res = self.cursor.fetchone()
        if res is not None:
            (self.state,output["Quad9"],output["stage_Quad9"])=(res["next_state"],res["Quad9"],res["stage_Quad9"])
        else:
