...
geometry_msgs::Vector3 AddVector3(const geometry_msgs::Vector3 &Vec1,
                                  const geometry_msgs::Vector3 &Vec2);

//Function to help subtracting two ROS Vector3
geometry_msgs::Vector3 SubtractVector3(const geometry_msgs::Vector3 &Vec1,
                                       const geometry_msgs::Vector3 &Vec2);
...
float normPoint(const geometry_msgs::Point &Pt);
...
geometry_msgs::Vector3 Point_2_Vec3(const geometry_msgs::Point &Pt);
...
Eigen::Vector3d normalizeVector3d(const Eigen::Vector3d &V);
